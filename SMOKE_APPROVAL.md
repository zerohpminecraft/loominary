...
- [x] **import-basic** — PASS — fingerprint `2d0ceafe20a7` — assertions: `PASS 3/3` — video: [import-basic.mp4](docs/videos/out/smoke/import-basic.mp4)
- [x] **preview-map** — PASS — fingerprint `2d0ceafe20a7` — assertions: `PASS 3/3` — video: [preview-map.mp4](docs/videos/out/smoke/preview-map.mp4)
