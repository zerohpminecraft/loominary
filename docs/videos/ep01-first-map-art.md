...
| 6:40 | **generated:** stills carousel, `import-gif.png`, `export-multitile.png`, `status-locked.png` | "Animated GIFs, wall-sized art, password-locked art, all supported, all coming up in this series." |
